...
//notice that this class has a main method, and a number of techniques for printing menus to the screen, as well as handling and manipulating data. 
//We include a number of different types of loops, as well. Of note is the use of a do while loop, since it is always ran at least once, ITS A GREAT 
//CHOICE FOR A MENU DRIVEN APPLICATION.